                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('pengeluaran.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_pengeluaran" id="tanggal_pengeluaran" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('tanggal_pengeluaran') }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tujuan" id="tujuan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('tujuan') }}" required>
                        </div>
